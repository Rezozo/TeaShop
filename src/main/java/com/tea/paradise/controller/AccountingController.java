...
import com.tea.paradise.service.*;
...
public class AccountingController {
    ...
    @Operation(summary = "Статистика по заказам за период")
    @GetMapping("statistics")
    public StatisticsDto getStatisticsByPeriod(@RequestParam("period") StatisticsSortType sortType) {
        return statisticsService.calculateStatistics(sortType);
    }
}
